...
var SQL_SELECT_ALL_PARTIES = "select * from parties;";
...
//create tables parties (id int not null auto_increment,
//name varchar--not done)
...
gulp.task('db_select_all_parties', function() {
  ...
  db.raw(SQL_SELECT_ALL_PARTIES).then(selectAllParties)
